...
from src.seq2seq_model import infer_onnx
...
if __name__ == '__main__':
    ...
    if args.is_modelarts:
        ...
        _config.onnx_file = '/cache/dataset_menu/seq2seq.onnx'

    _config.test_dataset = args.test_dataset
    _config.onnx_file = args.onnx_file

    result = infer_onnx(_config)
